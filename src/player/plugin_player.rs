...
use crate::player::post_system_player_apply_input::player_apply_input;
use crate::player::post_system_player_kinematics::player_sync_kinematics;
use crate::player::post_system_player_sync_state_position::player_sync_state_position;
use crate::player::pre_system_player_kinematics::{player_reset_kinematics, PlayerKinematics};
...
impl Plugin for PlayerPlugin {
    fn build(&self, app: &mut App) {
        app.init_resource::<PlayerState>()
            ...
            .add_system_to_stage(CoreStage::PostUpdate, player_sync_kinematics);
    }
}
